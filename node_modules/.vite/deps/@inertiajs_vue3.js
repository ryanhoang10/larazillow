...
async function E({ id: e = "app", resolve: o, setup: n, title: l, progress: t = {}, page: p, render: a }) {
  let m = typeof window > "u", d = m ? null : document.getElementById(e), h2 = p || JSON.parse(d.dataset.page), r = (f2) => Promise.resolve(o(f2)).then((g) => g.default || g), i = [], s = await r(h2.component).then((f2) => n({ el: d, App: I2, props: { initialPage: h2, initialComponent: f2, resolveComponent: r, titleCallback: l, onHeadUpdate: m ? (g) => i = g : null }, plugin: $2 }));
  if (!m && t && Z(t), m) {
